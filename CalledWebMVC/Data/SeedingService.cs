...
namespace CalledWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Sprint s1 = new Sprint(1, "Pj Casa Amarela SP-1", new DateTime(2021, 11, 15), new DateTime(2021, 12, 17), "Começar fundação da casa", 1);
         ...
         /*   new DateTime(2022, 01, 18), new DateTime(2022, 01, 22),*/ 1, 3, "Construção", Status.Todo);
            ...
            Sprint s2 = new Sprint(2, "Pj Casa Amarela SP-2", new DateTime(2021, 12, 20), new DateTime(2022, 01, 21), "Finalizar a fundação da casa e iniciar a Estrutura", 1);
          ...
          /*  new DateTime(2022, 01, 14), new DateTime(2022, 01, 16),*/ 2, 3, "Construção", Status.Todo);
            ...
            Projeto p1 = new Projeto(1, "Projeto Casa Amarela", "Projeto referente a construção de uma casa simples", new DateTime(2021, 11, 15), Status.InProgress);
            Projeto p2 = new Projeto(2, "Predio 44", "Projeto referente a construção de um predio de 4 andares", new DateTime(2020, 01, 01), Status.Concluido);
